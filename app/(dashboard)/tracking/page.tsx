...
export default function TrackingPage() {
  ...
  return (
    <div className="relative h-screen flex overflow-hidden">
      ...
      {/* Sidebar List */}
      <div className="w-80 flex flex-col border-r border-gray-200 bg-white/80 z-20">
        ...
        {/* Bus Info Card */}
        {selectedBus && (
          <div className="p-3 space-y-4 flex-1 overflow-y-auto bg-gray-50/50">
            ...
            <div className="space-y-3">
              <div className="flex items-center p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900">42 km/h</p>
                </div>
              </div>
              <div className="flex items-center p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
              ...
              <div className="flex items-center p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900">4 mins</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 mt-auto">
              <button
                ...
                className="w-full py-3 bg-gray-900 text-white hover:opacity-90 text-xs font-bold rounded-xl transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2"
              >
                Contact Driver
              </button>
            </div>
      ...
      {/* Map View */}
      <div className="flex-1 relative bg-gray-100 transition-colors">
        ...
        <div className="absolute top-3 right-4 z-10 flex flex-col space-y-2">
          <button
            ...
            className="p-3 bg-white/90 rounded-xl text-gray-700 hover:bg-gray-100 transition-all shadow-lg border border-gray-200"
          >
            <Navigation size={20} />
          </button>
          <button className="p-3 bg-white/90 rounded-xl text-gray-700 hover:bg-gray-100 transition-all shadow-lg border border-gray-200">
            <Bus size={20} />
          </button>
        </div>
      </div>
